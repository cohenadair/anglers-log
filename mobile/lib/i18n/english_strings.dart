Map<String, Map<String, String>> get englishStrings => {
  ...
  "default" : {
    ...
    "reportSummary_viewSpeciesDescription" : "Viewing number of catches per species for all species in your log.",
    "reportSummary_viewFishingSpots" : "View all fishing spots",
    "reportSummary_viewFishingSpotsDescription" : "Viewing number of catches per fishing spot for all fishing spots your log.",
    "reportSummary_viewBaits" : "View all baits",
    "reportSummary_viewBaitsDescription" : "Viewing number of catches per bait for all baits in your log.",
    "reportSummary_speciesTitle" : "Species Summary",
    "reportSummary_speciesPerFishingSpotDescription" : "Viewing number of each species caught per fishing spot for all fishing spots in your log.",
    "reportSummary_speciesPerBaitDescription" : "Viewing number of each species caught per bait for all baits in your log.",
    "reportSummary_fishingSpotsPerSpeciesDescription" : "Viewing number of %s caught at each fishing spot in your log",
    "reportSummary_baitsPerSpeciesDescription" : "Viewing number of %s caught using each bait in your log",
