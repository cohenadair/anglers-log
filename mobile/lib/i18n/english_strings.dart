Map<String, Map<String, String>> get englishStrings => {
  ...
  "default" : {
    ...
    "overviewReportView_species" : "Per species",
    "overviewReportView_sinceLastCatch" : "Since last catch",
    "overviewReportView_numberOfCatches" : "Number of catches",
    "overviewReportView_fishingSpots" : "Per fishing spot",
    "overviewReportView_baits" : "Per bait",
    "overviewReportView_viewSpecies" : "View all species",
    "overviewReportView_viewSpeciesDescription" : "Viewing number of catches per species for all species in your log.",
    "overviewReportView_viewFishingSpots" : "View all fishing spots",
    "overviewReportView_viewFishingSpotsDescription" : "Viewing number of catches per fishing spot for all fishing spots your log.",
    "overviewReportView_viewBaits" : "View all baits",
    "overviewReportView_viewBaitsDescription" : "Viewing number of catches per bait for all baits in your log.",
    "overviewReportView_speciesSummary" : "Species Summary",
    "overviewReportView_speciesPerFishingSpotDescription" : "Viewing number of each species caught per fishing spot for all fishing spots in your log.",
    "overviewReportView_speciesPerBaitDescription" : "Viewing number of each species caught per bait for all baits in your log.",
    "overviewReportView_fishingSpotsPerSpeciesDescription" : "Viewing number of %s caught at each fishing spot in your log",
    "overviewReportView_baitsPerSpeciesDescription" : "Viewing number of %s caught using each bait in your log",
