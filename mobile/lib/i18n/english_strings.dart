...
Map<String, Map<String, String>> get englishStrings => {
      ...
      "default": {
        ...
        "proPage_speciesCounter": "Realtime species caught counter",
        "period_dawn": "Dawn",
        ...
        "speciesCounterPage_title": "Species Counter",
        "speciesCounterPage_reset": "Reset",
        "speciesCounterPage_createTrip": "Create Trip",
        "speciesCounterPage_addToTrip": "Append Trip",
        ...
        "changeLog_2.7.0_5": "Fixed an issue where reports would show the same data for different time periods.",
        "changeLog_2.7.0_6": "Fixed an issue where you couldn't choose the CSV save location on some devices.",
        "changeLog_2.7.0_7": "Fixed an issue where you couldn't share catches or trips on some devices.",
        "changeLog_2.7.0_8": "Fixed an issue where the Trip Summary report would show incorrect best length and weight values.",
        "changeLog_2.7.0_9": "Fixed an errorneous network error when trying to send us feedback.",
        "changeLog_2.7.0_10": "Fishing spots can now be skipped when adding a catch.",
        "changeLog_2.7.0_11": "Fishing spots can now be removed from catches.",
        "changeLog_2.7.0_12": "Exported CSV files now include latitude and longitude columns.",
        "changeLog_2.7.0_13": "Exported CSV files now include custom fields.",
        "changeLog_2.7.0_14": "Users are now notified when automatic backups fail.",
        "changeLog_2.7.0_15": "Tide charts now show low and high tide heights.",
        "changeLog_2.7.0_16": "Meters per second has been added as a wind speed unit option.",
        "changeLog_2.7.0_17": "The \"Skunked\" stamp now says \"Blanked\" for UK users.",
      },
    };
