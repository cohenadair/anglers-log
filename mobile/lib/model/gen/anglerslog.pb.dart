...
class CustomEntity extends $pb.GeneratedMessage {
  ...
  CustomEntity copyWith(void Function(CustomEntity) updates) => super.copyWith((message) => updates(message as CustomEntity));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CustomEntityValue extends $pb.GeneratedMessage {
  ...
  CustomEntityValue copyWith(void Function(CustomEntityValue) updates) => super.copyWith((message) => updates(message as CustomEntityValue));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Bait extends $pb.GeneratedMessage {
  ...
  Bait copyWith(void Function(Bait) updates) => super.copyWith((message) => updates(message as Bait));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BaitCategory extends $pb.GeneratedMessage {
  ...
  BaitCategory copyWith(void Function(BaitCategory) updates) => super.copyWith((message) => updates(message as BaitCategory));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Catch extends $pb.GeneratedMessage {
  ...
  Catch copyWith(void Function(Catch) updates) => super.copyWith((message) => updates(message as Catch));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FishingSpot extends $pb.GeneratedMessage {
  ...
  FishingSpot copyWith(void Function(FishingSpot) updates) => super.copyWith((message) => updates(message as FishingSpot));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Species extends $pb.GeneratedMessage {
  ...
  Species copyWith(void Function(Species) updates) => super.copyWith((message) => updates(message as Species));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SummaryReport extends $pb.GeneratedMessage {
  ...
  SummaryReport copyWith(void Function(SummaryReport) updates) => super.copyWith((message) => updates(message as SummaryReport));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set startTimestamp($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set endTimestamp($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class ComparisonReport extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ComparisonReport', package: const $pb.PackageName('anglerslog'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(6, 'fromStartTimestamp', subBuilder: $0.Timestamp.create)
  ...
  ComparisonReport copyWith(void Function(ComparisonReport) updates) => super.copyWith((message) => updates(message as ComparisonReport));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set fromStartTimestamp($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set toStartTimestamp($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set fromEndTimestamp($0.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set toEndTimestamp($0.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
