...
class Period extends $pb.ProtobufEnum {
  static const Period all = Period._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'all');
  static const Period none = Period._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'none');
