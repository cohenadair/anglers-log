...
class SkyCondition extends $pb.ProtobufEnum {
  ...
  static const SkyCondition clear = SkyCondition._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'clear');
  static const SkyCondition sunny = SkyCondition._(
      16,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'sunny');
...
class Bait_Type extends $pb.ProtobufEnum {
  static const Bait_Type artificial = Bait_Type._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'artificial');
  static const Bait_Type real = Bait_Type._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'real');
  static const Bait_Type live = Bait_Type._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'live');
