...
class SkyCondition extends $pb.ProtobufEnum {
  ...
  static const SkyCondition sunny = SkyCondition._(16, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'sunny');
...
class Unit extends $pb.ProtobufEnum {
  ...
  static const Unit inch_of_mercury = Unit._(16, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'inch_of_mercury');
...
class CatchFilterOptions_Order extends $pb.ProtobufEnum {
  static const CatchFilterOptions_Order unknown = CatchFilterOptions_Order._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'unknown');
  static const CatchFilterOptions_Order newest_to_oldest = CatchFilterOptions_Order._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'newest_to_oldest');
  static const CatchFilterOptions_Order heaviest_to_lightest = CatchFilterOptions_Order._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'heaviest_to_lightest');
  static const CatchFilterOptions_Order longest_to_shortest = CatchFilterOptions_Order._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'longest_to_shortest');
