...
final $typed_data.Uint8List periodDescriptor = $convert.base64Decode('CgZQZXJpb2QSBwoDYWxsEAASCAoEbm9uZRABEggKBGRhd24QAhILCgdtb3JuaW5nEAMSCgoGbWlkZGF5EAQSDQoJYWZ0ZXJub29uEAUSCAoEZHVzaxAGEgkKBW5pZ2h0EAc=');
...
final $typed_data.Uint8List catchDescriptor = $convert.base64Decode('');
...
const SummaryReport$json = const {
  ...
  '2': const [
    ...
    const {'1': 'start_timestamp', '3': 5, '4': 1, '5': 4, '10': 'startTimestamp'},
...
final $typed_data.Uint8List summaryReportDescriptor = $convert.base64Decode('');
...
const ComparisonReport$json = const {
  ...
  '2': const [
    ...
    const {'1': 'from_start_timestamp', '3': 6, '4': 1, '5': 4, '10': 'fromStartTimestamp'},
    const {'1': 'to_start_timestamp', '3': 7, '4': 1, '5': 4, '10': 'toStartTimestamp'},
    const {'1': 'from_end_timestamp', '3': 8, '4': 1, '5': 4, '10': 'fromEndTimestamp'},
    const {'1': 'to_end_timestamp', '3': 9, '4': 1, '5': 4, '10': 'toEndTimestamp'},
    ...
    const {'1': 'angler_ids', '3': 13, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'anglerIds'},
    const {'1': 'method_ids', '3': 14, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'methodIds'},
    const {'1': 'periods', '3': 15, '4': 3, '5': 14, '6': '.anglerslog.Period', '10': 'periods'},
  ],
};

/// Descriptor for `ComparisonReport`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List comparisonReportDescriptor = $convert.base64Decode('');
