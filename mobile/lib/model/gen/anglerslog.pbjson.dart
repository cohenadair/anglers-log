...
final $typed_data.Uint8List skyConditionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List unitDescriptor = $convert.base64Decode('');
...
const Atmosphere$json = const {
  '1': 'Atmosphere',
  '2': const [
    const {'1': 'temperature_deprecated', '3': 1, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'temperatureDeprecated'},
    const {'1': 'sky_conditions', '3': 2, '4': 3, '5': 14, '6': '.anglerslog.SkyCondition', '10': 'skyConditions'},
    const {'1': 'wind_speed_deprecated', '3': 3, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'windSpeedDeprecated'},
    const {'1': 'wind_direction', '3': 4, '4': 1, '5': 14, '6': '.anglerslog.Direction', '10': 'windDirection'},
    const {'1': 'pressure_deprecated', '3': 5, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'pressureDeprecated'},
    const {'1': 'humidity_deprecated', '3': 6, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'humidityDeprecated'},
    const {'1': 'visibility_deprecated', '3': 7, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'visibilityDeprecated'},
    ...
    const {'1': 'temperature', '3': 12, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'temperature'},
    const {'1': 'wind_speed', '3': 13, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'windSpeed'},
    const {'1': 'pressure', '3': 14, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'pressure'},
    const {'1': 'humidity', '3': 15, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'humidity'},
    const {'1': 'visibility', '3': 16, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'visibility'},
  ],
};

/// Descriptor for `Atmosphere`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List atmosphereDescriptor = $convert.base64Decode('');
...
const Trip$json = const {
  ...
  '2': const [
    ...
    const {'1': 'gps_trail_ids', '3': 16, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'gpsTrailIds'},
  ],
...
final $typed_data.Uint8List tripDescriptor = $convert.base64Decode('');
...
const MultiMeasurement$json = const {
  ...
  '2': const [
    ...
    const {'1': 'main_value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'mainValue'},
    const {'1': 'fraction_value', '3': 3, '4': 1, '5': 11, '6': '.anglerslog.Measurement', '10': 'fractionValue'},
    const {'1': 'is_negative', '3': 4, '4': 1, '5': 8, '10': 'isNegative'},
  ],
};

/// Descriptor for `MultiMeasurement`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List multiMeasurementDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use tideDescriptor instead')
const Tide$json = const {
  '1': 'Tide',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.anglerslog.TideType', '10': 'type'},
    const {'1': 'first_low_timestamp', '3': 2, '4': 1, '5': 4, '10': 'firstLowTimestamp'},
    const {'1': 'first_high_timestamp', '3': 3, '4': 1, '5': 4, '10': 'firstHighTimestamp'},
    const {'1': 'time_zone', '3': 4, '4': 1, '5': 9, '10': 'timeZone'},
    const {'1': 'height', '3': 5, '4': 1, '5': 11, '6': '.anglerslog.Tide.Height', '10': 'height'},
    const {'1': 'days_heights', '3': 6, '4': 3, '5': 11, '6': '.anglerslog.Tide.Height', '10': 'daysHeights'},
    const {'1': 'second_low_timestamp', '3': 7, '4': 1, '5': 4, '10': 'secondLowTimestamp'},
    const {'1': 'second_high_timestamp', '3': 8, '4': 1, '5': 4, '10': 'secondHighTimestamp'},
  ],
...
final $typed_data.Uint8List tideDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use catchFilterOptionsDescriptor instead')
const CatchFilterOptions$json = const {
  '1': 'CatchFilterOptions',
  '2': const [
    const {'1': 'order', '3': 1, '4': 1, '5': 14, '6': '.anglerslog.CatchFilterOptions.Order', '10': 'order'},
    const {'1': 'current_timestamp', '3': 2, '4': 1, '5': 4, '10': 'currentTimestamp'},
    const {'1': 'current_time_zone', '3': 3, '4': 1, '5': 9, '10': 'currentTimeZone'},
    const {'1': 'all_anglers', '3': 4, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllAnglersEntry', '10': 'allAnglers'},
    const {'1': 'all_baits', '3': 5, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllBaitsEntry', '10': 'allBaits'},
    const {'1': 'all_bodies_of_water', '3': 6, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllBodiesOfWaterEntry', '10': 'allBodiesOfWater'},
    const {'1': 'all_catches', '3': 7, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllCatchesEntry', '10': 'allCatches'},
    const {'1': 'all_fishing_spots', '3': 8, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllFishingSpotsEntry', '10': 'allFishingSpots'},
    const {'1': 'all_methods', '3': 9, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllMethodsEntry', '10': 'allMethods'},
    const {'1': 'all_species', '3': 10, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllSpeciesEntry', '10': 'allSpecies'},
    const {'1': 'all_water_clarities', '3': 11, '4': 3, '5': 11, '6': '.anglerslog.CatchFilterOptions.AllWaterClaritiesEntry', '10': 'allWaterClarities'},
    const {'1': 'is_catch_and_release_only', '3': 12, '4': 1, '5': 8, '10': 'isCatchAndReleaseOnly'},
    const {'1': 'is_favorites_only', '3': 13, '4': 1, '5': 8, '10': 'isFavoritesOnly'},
    const {'1': 'date_ranges', '3': 14, '4': 3, '5': 11, '6': '.anglerslog.DateRange', '10': 'dateRanges'},
    const {'1': 'baits', '3': 15, '4': 3, '5': 11, '6': '.anglerslog.BaitAttachment', '10': 'baits'},
    const {'1': 'catch_ids', '3': 16, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'catchIds'},
    const {'1': 'angler_ids', '3': 17, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'anglerIds'},
    const {'1': 'fishing_spot_ids', '3': 18, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'fishingSpotIds'},
    const {'1': 'body_of_water_ids', '3': 19, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'bodyOfWaterIds'},
    const {'1': 'method_ids', '3': 20, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'methodIds'},
    const {'1': 'species_ids', '3': 21, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'speciesIds'},
    const {'1': 'water_clarity_ids', '3': 22, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'waterClarityIds'},
    const {'1': 'periods', '3': 23, '4': 3, '5': 14, '6': '.anglerslog.Period', '10': 'periods'},
    const {'1': 'seasons', '3': 24, '4': 3, '5': 14, '6': '.anglerslog.Season', '10': 'seasons'},
    const {'1': 'wind_directions', '3': 25, '4': 3, '5': 14, '6': '.anglerslog.Direction', '10': 'windDirections'},
    const {'1': 'sky_conditions', '3': 26, '4': 3, '5': 14, '6': '.anglerslog.SkyCondition', '10': 'skyConditions'},
    const {'1': 'moon_phases', '3': 27, '4': 3, '5': 14, '6': '.anglerslog.MoonPhase', '10': 'moonPhases'},
    const {'1': 'tide_types', '3': 28, '4': 3, '5': 14, '6': '.anglerslog.TideType', '10': 'tideTypes'},
    const {'1': 'water_depth_filter', '3': 29, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'waterDepthFilter'},
    const {'1': 'water_temperature_filter', '3': 30, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'waterTemperatureFilter'},
    const {'1': 'length_filter', '3': 31, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'lengthFilter'},
    const {'1': 'weight_filter', '3': 32, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'weightFilter'},
    const {'1': 'quantity_filter', '3': 33, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'quantityFilter'},
    const {'1': 'air_temperature_filter', '3': 34, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'airTemperatureFilter'},
    const {'1': 'air_pressure_filter', '3': 35, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'airPressureFilter'},
    const {'1': 'air_humidity_filter', '3': 36, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'airHumidityFilter'},
    const {'1': 'air_visibility_filter', '3': 37, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'airVisibilityFilter'},
    const {'1': 'wind_speed_filter', '3': 38, '4': 1, '5': 11, '6': '.anglerslog.NumberFilter', '10': 'windSpeedFilter'},
    const {'1': 'hour', '3': 39, '4': 1, '5': 5, '10': 'hour'},
    const {'1': 'month', '3': 40, '4': 1, '5': 5, '10': 'month'},
    const {'1': 'include_anglers', '3': 41, '4': 1, '5': 8, '10': 'includeAnglers'},
    const {'1': 'include_baits', '3': 42, '4': 1, '5': 8, '10': 'includeBaits'},
    const {'1': 'include_bodies_of_water', '3': 43, '4': 1, '5': 8, '10': 'includeBodiesOfWater'},
    const {'1': 'include_methods', '3': 44, '4': 1, '5': 8, '10': 'includeMethods'},
    const {'1': 'include_fishing_spots', '3': 45, '4': 1, '5': 8, '10': 'includeFishingSpots'},
    const {'1': 'include_moon_phases', '3': 46, '4': 1, '5': 8, '10': 'includeMoonPhases'},
    const {'1': 'include_seasons', '3': 47, '4': 1, '5': 8, '10': 'includeSeasons'},
    const {'1': 'include_species', '3': 48, '4': 1, '5': 8, '10': 'includeSpecies'},
    const {'1': 'include_tide_types', '3': 49, '4': 1, '5': 8, '10': 'includeTideTypes'},
    const {'1': 'include_periods', '3': 50, '4': 1, '5': 8, '10': 'includePeriods'},
    const {'1': 'include_water_clarities', '3': 51, '4': 1, '5': 8, '10': 'includeWaterClarities'},
  ],
  '3': const [CatchFilterOptions_AllAnglersEntry$json, CatchFilterOptions_AllBaitsEntry$json, CatchFilterOptions_AllBodiesOfWaterEntry$json, CatchFilterOptions_AllCatchesEntry$json, CatchFilterOptions_AllFishingSpotsEntry$json, CatchFilterOptions_AllMethodsEntry$json, CatchFilterOptions_AllSpeciesEntry$json, CatchFilterOptions_AllWaterClaritiesEntry$json],
...
const CatchFilterOptions_AllAnglersEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Angler', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllBaitsEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Bait', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllBodiesOfWaterEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.BodyOfWater', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllCatchesEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Catch', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllFishingSpotsEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.FishingSpot', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllMethodsEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Method', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllSpeciesEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Species', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const CatchFilterOptions_AllWaterClaritiesEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.WaterClarity', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
final $typed_data.Uint8List catchFilterOptionsDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use catchReportDescriptor instead')
const CatchReport$json = const {
  '1': 'CatchReport',
  '2': const [
    const {'1': 'models', '3': 1, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel', '10': 'models'},
    const {'1': 'ms_since_last_catch', '3': 2, '4': 1, '5': 4, '10': 'msSinceLastCatch'},
    const {'1': 'last_catch', '3': 3, '4': 1, '5': 11, '6': '.anglerslog.Catch', '10': 'lastCatch'},
    const {'1': 'contains_now', '3': 6, '4': 1, '5': 8, '10': 'containsNow'},
  ],
};

/// Descriptor for `CatchReport`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List catchReportDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use catchReportModelDescriptor instead')
const CatchReportModel$json = const {
  '1': 'CatchReportModel',
  '2': const [
    const {'1': 'date_range', '3': 1, '4': 1, '5': 11, '6': '.anglerslog.DateRange', '10': 'dateRange'},
    const {'1': 'catch_ids', '3': 2, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'catchIds'},
    const {'1': 'per_hour', '3': 3, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerHourEntry', '10': 'perHour'},
    const {'1': 'per_month', '3': 4, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerMonthEntry', '10': 'perMonth'},
    const {'1': 'per_moon_phase', '3': 5, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerMoonPhaseEntry', '10': 'perMoonPhase'},
    const {'1': 'per_period', '3': 6, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerPeriodEntry', '10': 'perPeriod'},
    const {'1': 'per_season', '3': 7, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerSeasonEntry', '10': 'perSeason'},
    const {'1': 'per_tide_type', '3': 8, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerTideTypeEntry', '10': 'perTideType'},
    const {'1': 'per_angler', '3': 9, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerAnglerEntry', '10': 'perAngler'},
    const {'1': 'per_body_of_water', '3': 10, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerBodyOfWaterEntry', '10': 'perBodyOfWater'},
    const {'1': 'per_method', '3': 11, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerMethodEntry', '10': 'perMethod'},
    const {'1': 'per_fishing_spot', '3': 12, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerFishingSpotEntry', '10': 'perFishingSpot'},
    const {'1': 'per_species', '3': 13, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerSpeciesEntry', '10': 'perSpecies'},
    const {'1': 'per_water_clarity', '3': 14, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerWaterClarityEntry', '10': 'perWaterClarity'},
    const {'1': 'per_bait', '3': 15, '4': 3, '5': 11, '6': '.anglerslog.CatchReportModel.PerBaitEntry', '10': 'perBait'},
  ],
  '3': const [CatchReportModel_PerHourEntry$json, CatchReportModel_PerMonthEntry$json, CatchReportModel_PerMoonPhaseEntry$json, CatchReportModel_PerPeriodEntry$json, CatchReportModel_PerSeasonEntry$json, CatchReportModel_PerTideTypeEntry$json, CatchReportModel_PerAnglerEntry$json, CatchReportModel_PerBodyOfWaterEntry$json, CatchReportModel_PerMethodEntry$json, CatchReportModel_PerFishingSpotEntry$json, CatchReportModel_PerSpeciesEntry$json, CatchReportModel_PerWaterClarityEntry$json, CatchReportModel_PerBaitEntry$json],
};
...
final $typed_data.Uint8List catchReportModelDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use tripFilterOptionsDescriptor instead')
const TripFilterOptions$json = const {
  '1': 'TripFilterOptions',
  '2': const [
    const {'1': 'current_timestamp', '3': 1, '4': 1, '5': 4, '10': 'currentTimestamp'},
    const {'1': 'current_time_zone', '3': 2, '4': 1, '5': 9, '10': 'currentTimeZone'},
    const {'1': 'all_catches', '3': 3, '4': 3, '5': 11, '6': '.anglerslog.TripFilterOptions.AllCatchesEntry', '10': 'allCatches'},
    const {'1': 'all_trips', '3': 4, '4': 3, '5': 11, '6': '.anglerslog.TripFilterOptions.AllTripsEntry', '10': 'allTrips'},
    const {'1': 'catch_weight_system', '3': 5, '4': 1, '5': 14, '6': '.anglerslog.MeasurementSystem', '10': 'catchWeightSystem'},
    const {'1': 'catch_length_system', '3': 6, '4': 1, '5': 14, '6': '.anglerslog.MeasurementSystem', '10': 'catchLengthSystem'},
    const {'1': 'date_range', '3': 7, '4': 1, '5': 11, '6': '.anglerslog.DateRange', '10': 'dateRange'},
    const {'1': 'trip_ids', '3': 8, '4': 3, '5': 11, '6': '.anglerslog.Id', '10': 'tripIds'},
  ],
  '3': const [TripFilterOptions_AllCatchesEntry$json, TripFilterOptions_AllTripsEntry$json],
};
...
const TripFilterOptions_AllTripsEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.anglerslog.Trip', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `TripFilterOptions`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tripFilterOptionsDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use tripReportDescriptor instead')
const TripReport$json = const {
  '1': 'TripReport',
  '2': const [
    const {'1': 'date_range', '3': 1, '4': 1, '5': 11, '6': '.anglerslog.DateRange', '10': 'dateRange'},
    const {'1': 'trips', '3': 2, '4': 3, '5': 11, '6': '.anglerslog.Trip', '10': 'trips'},
    const {'1': 'total_ms', '3': 3, '4': 1, '5': 4, '10': 'totalMs'},
    const {'1': 'longest_trip', '3': 4, '4': 1, '5': 11, '6': '.anglerslog.Trip', '10': 'longestTrip'},
    const {'1': 'last_trip', '3': 5, '4': 1, '5': 11, '6': '.anglerslog.Trip', '10': 'lastTrip'},
    const {'1': 'ms_since_last_trip', '3': 6, '4': 1, '5': 4, '10': 'msSinceLastTrip'},
    const {'1': 'containsNow', '3': 7, '4': 1, '5': 8, '10': 'containsNow'},
    const {'1': 'average_catches_per_trip', '3': 8, '4': 1, '5': 1, '10': 'averageCatchesPerTrip'},
    const {'1': 'average_catches_per_hour', '3': 9, '4': 1, '5': 1, '10': 'averageCatchesPerHour'},
    const {'1': 'average_ms_between_catches', '3': 10, '4': 1, '5': 4, '10': 'averageMsBetweenCatches'},
    const {'1': 'average_trip_ms', '3': 11, '4': 1, '5': 4, '10': 'averageTripMs'},
    const {'1': 'average_ms_between_trips', '3': 12, '4': 1, '5': 4, '10': 'averageMsBetweenTrips'},
    const {'1': 'average_weight_per_trip', '3': 13, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'averageWeightPerTrip'},
    const {'1': 'most_weight_in_single_trip', '3': 14, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'mostWeightInSingleTrip'},
    const {'1': 'most_weight_trip', '3': 15, '4': 1, '5': 11, '6': '.anglerslog.Trip', '10': 'mostWeightTrip'},
    const {'1': 'average_length_per_trip', '3': 16, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'averageLengthPerTrip'},
    const {'1': 'most_length_in_single_trip', '3': 17, '4': 1, '5': 11, '6': '.anglerslog.MultiMeasurement', '10': 'mostLengthInSingleTrip'},
    const {'1': 'most_length_trip', '3': 18, '4': 1, '5': 11, '6': '.anglerslog.Trip', '10': 'mostLengthTrip'},
  ],
};

/// Descriptor for `TripReport`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tripReportDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List gpsTrailPointDescriptor = $convert.base64Decode('Cg1HcHNUcmFpbFBvaW50EhwKCXRpbWVzdGFtcBgBIAEoBFIJdGltZXN0YW1wEhAKA2xhdBgCIAEoAVIDbGF0EhAKA2xuZxgDIAEoAVIDbG5nEhgKB2hlYWRpbmcYBCABKAFSB2hlYWRpbmc=');
...
const GpsTrail$json = const {
  ...
  '2': const [
    ...
    const {'1': 'end_timestamp', '3': 3, '4': 1, '5': 4, '10': 'endTimestamp'},
    const {'1': 'time_zone', '3': 4, '4': 1, '5': 9, '10': 'timeZone'},
    const {'1': 'points', '3': 5, '4': 3, '5': 11, '6': '.anglerslog.GpsTrailPoint', '10': 'points'},
    const {'1': 'body_of_water_id', '3': 6, '4': 1, '5': 11, '6': '.anglerslog.Id', '10': 'bodyOfWaterId'},
  ],
};

/// Descriptor for `GpsTrail`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gpsTrailDescriptor = $convert.base64Decode('');
