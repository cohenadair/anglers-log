        ...
        child: EntityListenerBuilder(
          ...
          builder: (context) => Column(
            ...
            children: [
              ...
              HeadingDivider(Strings.of(context).statsOverviewSummary),
              _buildSummary(),
            ],
          ),
        ),
      ...
      child: Column(
        ...
        children: [
          _hasCatches ? LabelValue(
            ...
            label: Strings.of(context).statsOverviewSinceLastCatch,
          ...
          LabelValue(
            ...
            label: Strings.of(context).statsOverviewTotalCatches,
      ...
      child: Align(
        ...
        child: Button(
          text: _summaryShowingAllSpecies
              ? format(Strings.of(context).statsOverviewShowOnlySpecies,
                  [_summarySpeciesMaxCount])
              : Strings.of(context).statsOverviewShowAllSpecies,
          onPressed: () => setState(() {
