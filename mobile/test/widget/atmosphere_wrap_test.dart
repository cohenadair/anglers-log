...
void main() {
  ...
  testWidgets("Shows all items", (tester) async {
    await tester.pumpWidget(
      Testable((_) => AtmosphereWrap(defaultAtmosphere())),
    );
        ...
        (_) => AtmosphereWrap(
          Atmosphere(
            windSpeed: MultiMeasurement(
              ...
              mainValue: Measurement(unit: Unit.miles_per_hour, value: 15),
            ),
          ),
        ),
      ),
  ...
  testWidgets("No temperature shows sky conditions", (tester) async {
    var context = await pumpContext(
      tester,
      (_) => AtmosphereWrap(
        Atmosphere(skyConditions: [SkyCondition.sunny, SkyCondition.clear]),
      ),
    );
